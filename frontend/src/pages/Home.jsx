        ...
        <div>
          ...
          <div className='mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-[30px]'>
            <div>
                ...
                <span className='w-[100px] h-2 bg-yellowColor rounded-full block mt-[-9px]'></span>
  ...
  <section>
    <div className="container">
      <div className='lg:w-[470px] mx-auto'>
        ...
        <p className='text__para text-center'>World-class care for everyone. Our health System offers unmatched, expert heath care.</p>
      </div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]'>
        ...
        <div className='py-[30px] px-5'>
          ...
          <div className='mt-[30px]'>
            ...
            <Link to='/doctors' className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:bg-none'>
        ...
        <div className='py-[30px] px-5'>
          ...
          <div className='mt-[30px]'>
            ...
            <p className='text-[16px] leading-7 text-textColor font-[400] mt-4 text-center'>World-class care for everyone. 
            Our health System offers unmatched, expert health care. From the lab to the clinic.</p>
            {/*============Link to='/doctors đấu mũi tên chuyển trang ở trang home==============*/}
            <Link to='/services' className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:bg-none'>
              <BsArrowRight className='group-hover:text-white w-6 h-5'/>
            </Link>
          </div>
        </div>
  ...
  <section>
    <div className="container">
      <div className="xl:w-[470px] mx-auto">
        <h2 className='heading text-center'>Our Media Services</h2>
