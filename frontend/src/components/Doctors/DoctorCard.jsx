...
const DoctorCard = ({ doctor }) => {
  const { name, specialization, avgRating, photo, totalPatients, hospital, totalRating } = doctor;
  ...
  return (
    <div className='p-3 lg:p-5'>
      ...
      <div className='mt-[18px] lg:mt-5 flex items-center justify-between'>
        ...
        <Link to='/doctors' className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] flex items-center justify-center group hover:bg-primaryColor hover:bg-none'>
